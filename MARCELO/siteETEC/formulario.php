...
<head>
    ...
    <title>Formulário - ETEC Zona Leste</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="logout.php">Sair (<?php echo htmlspecialchars($_SESSION['usuario']); ?>)</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container section-glass mt-5">
    ...
    <p class="text-center">Bem-vindo, <strong><?php echo htmlspecialchars($_SESSION['usuario']); ?></strong>! Preencha o formulário abaixo.</p>
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow p-4">
                <form action="processo.php" method="POST" id="formContato">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="telefone" id="telefone" class="form-control" placeholder="(11) 99999-9999">
                    </div>
